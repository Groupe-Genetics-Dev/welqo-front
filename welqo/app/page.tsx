          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            <div className="flex items-center gap-3 flex-shrink-0">
              <div className="relative">
                <Image src="/welqo-logo.png" alt="Welqo Logo" width={45} height={45} className="rounded-lg shadow-lg" />
          ...
          {isMenuOpen && (
            <div className="lg:hidden border-t bg-white/98 backdrop-blur-md">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <div className="pt-2">
                  <Button className="w-full bg-gradient-to-r from-[#082038] to-[#efb83b] hover:from-[#082038] hover:to-[#efb83b] text-white">
                    Commencer
                  </Button>
                </div>
              </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="sm:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <div className="relative">
                  <Image src="/welqo-logo.png" alt="Welqo Logo" width={40} height={40} className="rounded-lg" />
                  <div className="absolute inset-0 bg-gradient-to-r from-[#efb83b] to-[#082038] rounded-lg opacity-20 animate-pulse"></div>
                </div>
                <div className="flex flex-col">
          ...
          <div className="border-t border-gray-800 mt-6 sm:mt-8 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Image src="/genetics-logo.png" alt="Genetics Logo" width={25} height={25} className="rounded" />
              <button
