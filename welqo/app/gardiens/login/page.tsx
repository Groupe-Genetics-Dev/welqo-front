          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Link href="/gardiens/forgot-password" className="text-sm text-amber-400 hover:text-amber-300">
                  Mot de passe oublié ?
                </Link>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-slate-400">
                ...
                <Link href="/gardiens/register" className="text-amber-400 hover:text-amber-300">
                  S'inscrire
                </Link>
              </p>
            </div>
