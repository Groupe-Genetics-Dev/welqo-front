  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.error) {
        ...
        const message = "Connexion gardien réussie, Redirection vers le tableau de bord...";
        ...
        setTimeout(() => {
          setSuccessMessage("");
          router.push('/gardiens/dashboard');
        }, 3000);
      }
    } catch (error) {
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
          <CardHeader className="space-y-1">
            <div className="flex items-center space-x-2">
              <Button variant="ghost" size="sm" className="text-slate-400 hover:text-white" onClick={() => router.push("/")}>
